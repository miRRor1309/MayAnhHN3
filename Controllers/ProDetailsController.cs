...
namespace MayAnhHN3.Controllers
{
    public class ProDetailsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "ProDeID,ProID,SupID,Price,RemainQuantity,SoldQuantity,ViewQuantity")] ProDetail proDetail)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ProDeID,ProID,SupID,Price,RemainQuantity,SoldQuantity,ViewQuantity")] ProDetail proDetail)
        {
            if (ModelState.IsValid)
            {
